...
public class RecycleviewAdapter  extends RecyclerView.Adapter<MyViewHolder>implements View.OnClickListener,View.OnLongClickListener{
    ...
    * 构造方法
    * */
    public RecycleviewAdapter(Context context,List<Contacts> datas){
    ...
    * */
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        //联系人姓名
        holder.tv_name.setText(mDatas.get(position).getContactsName());

        //联系人手机号
        holder.tv_number.setText(mDatas.get(position).getContactNumber());
     ...
     //   Log.d("Glide显示图片",""+mDatas.get(position));
        Glide
                ...
                //设置我们的图片数据（网络图片的url）
                //.load(mDatas.get(position).getContactImg())

                .load(R.drawable.img_rabit)
                ...
                .into(holder.iv_show);        //这里用于之后的图片加载到什么地方
...
class MyViewHolder extends RecyclerView.ViewHolder{
    ...
    public MyViewHolder(View itemView) {
        super(itemView);
        tv_name= (TextView) itemView.findViewById(R.id.tv_name_MainActivityitemView);
        tv_number= (TextView) itemView.findViewById(R.id.tv_photoNumber_MainActivityitemview);
        iv_show= (ImageView) itemView.findViewById(R.id.iv_showImage_MainActivityitemView);
